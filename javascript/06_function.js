...
// 1. function 키워드 삭제 후 =>
let myArrowFunction1 = (a) => {return a + 1}
...
let ArrowSquare1 = (num) => {return num**2}
let ArrowSquare2 = num => {return num**2}
...
let ArrowGreeting1 = () => {console.log('happy!')}
// 1-3. 인자가 없는 경우에는 () or _
let ArrowGreeting2 = _ => {console.log('happy!')}
